...
const PORTRAIT_PROMPTS = {
    ...
    "serel": `ageless wandering shrine keeper in undyed gray robes worn soft by the road, calm deep-lined face, a plain wooden bowl hanging from a cord at their chest, quiet knowing expression, ${PORTRAIT_BASE}`,
    "sefa": `elderly road keeper with a walking staff, sun-faded shawl over travel robes, kind stubborn face with a fresh cut above one brow, ${PORTRAIT_BASE}`,
