 ...
 *
 * Re-run after touching the client sim. api/_pet-sim/_parity.test.ts asserts the
...
// GEN_PET_SIM_OUT lets the parity test generate into a temp dir and diff against
// the committed mirror without touching the tree. Unset in normal use.
const OUT = process.env.GEN_PET_SIM_OUT || join(root, "api", "_pet-sim");
