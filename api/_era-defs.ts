...
export const ERA_DEFS: readonly EraDef[] = [
    {
        ...
        lore: 'The first academy rosters are still kept downstairs, complete with ink blots and disciplinary notes.',
        chronicle: [
            'Stormveil, Ashen Leaf, Frostfang, and Moonshadow opened their academies to a new generation.',
            ...
            'The Academy Trials produced this era\'s first Genin. Some of those names are carved in the Hall now.',
        ],
    ...
    },
    {
        ...
        chronicle: [
            ...
            'Sectors changed hands by shinobi assault, companion challenge, and Chronicle Showdown. Commanders complained about the last one right up until it won them territory.',
            'Mercenary bands found steady ryo in other villages\' wars. Border clerks have been revising the same maps ever since.',
        ],
    ...
    },
    {
        ...
        description: 'Great beasts crossed the old borders, and all four villages learned to hold one battle line.',
        lore: 'The first joint battle order has four village seals and seventeen corrections in the margins.',
        chronicle: [
    ...
    },
    {
        ...
        chronicle: [
            ...
            'Eight strangers now walk the sectors: a storm-caller, a masked mother, an iron disciple, a blade-keeper, a duel-broker, a hollow warden, a lantern-bearer, and a mapless cartographer.',
            'The Hall compares witnessed missions, duels, and Gate extractions against the hundred patterns left by the Withheld. Recognition still requires a shinobi to accept the name.',
        ],
