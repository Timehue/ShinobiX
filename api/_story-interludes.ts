...
function def(village: string, levelReq: number, traits: Record<string, StoryLane>): StoryInterludeDef {
    return {
...
export const STORY_INTERLUDE_DEFS: Record<string, StoryInterludeDef> = Object.fromEntries(DEFS.map((d) => [d.id, d]));
