 ...
 */
export function sealTowerFighter(saveChar: Record<string, unknown>, save: Record<string, unknown> | null = null): Record<string, unknown> {
    // No client payload — the tower is server-authoritative; the save IS the source of truth.
    const hydrated = hydrateCharacterFromSave(saveChar, {}, save);
