...
const FROZEN = {
    ...
    COMBAT_STRIP_CHAR_FIELDS: [
        ...
        'petRankedSettlementStamp', 'playerRankedSettlementStamp', 'vanguardRewardSettlementStamp',
    ...
    STRICT_SERVER_LEDGER_CHARACTER_FIELDS: [
        ...
        'rankedSeasonSettlementReceipts', 'petRankedSettlementStamp', 'playerRankedSettlementStamp', 'vanguardRewardSettlementStamp',
