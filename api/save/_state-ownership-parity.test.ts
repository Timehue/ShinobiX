...
const FROZEN = {
    ...
    COMBAT_STRIP_CHAR_FIELDS: [
        ...
        'rankedWins', 'rankedLosses', 'rankedSeasonSettlementReceipts',
        'petRankedSettlementStamp', 'playerRankedSettlementStamp', 'vanguardRewardSettlementStamp', 'settledHollowGateCombatIds', 'hollowGateCombatSettlements',
    ...
    STRICT_SERVER_LEDGER_CHARACTER_FIELDS: [
        ...
        'rankedSeasonSettlementReceipts', 'petRankedSettlementStamp', 'playerRankedSettlementStamp', 'vanguardRewardSettlementStamp', 'settledHollowGateCombatIds', 'hollowGateCombatSettlements',
        'soloPveCompanionSettlements', 'soloPveItemSettlements', 'aiFightRewardSettlements',
        'weeklyBossStartSettlements', 'weeklyBossUsageSettlements', 'weeklyBossPayoutSettlements', 'combatMissionClaimSettlements', 'bountySagaStamp',
    ...
    PROGRESSION_ENTITLEMENT_CHARACTER_FIELDS: [
        'auraSphereLevel', 'redeemedAuraFeeds', 'battleTowerAscension',
        'battleTowerSpireWeeklyBest', 'battleTowerSpireWeekKey', 'rankedSeasonsWon',
    ...
    PET_IDENTITY_FIELDS: [
        ...
        'hatchedAt', 'breedable', 'breedingSessionId',
    ],
};
