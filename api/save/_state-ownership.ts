...
export const SAVE_FIELD_CONTRACT: readonly SaveFieldDef[] = [
    ...
    f('accountName', 'character', 'server-owned', 'identity', ['public-char', 'server-mirror-char'], 'Mutable public/login name; account-name endpoint only. name remains the stable account ID.'),
    ...
    f('riftFirstClears', 'character', 'server-owned', 'hollow-gate', ['combat-strip-char', 'server-mirror-char'], 'stamped only by verified rift completion'),
    f('riftQuestBossReceipt', 'character', 'server-owned', 'hollow-gate', ['combat-strip-char', 'server-mirror-char'], 'exact boss-to-completion bridge receipt'),
    ...
    f('hollowGatePendingOperation', 'character', 'server-payout-stamp', 'hollow-gate', ['strict-ledger-char', 'always-ledger-char', 'combat-strip-char'], 'co-written run-effect recovery proof; only trusted Hollow Gate handlers may advance it'),
    ...
    f('redeemedTebexPurchases', 'character', 'server-payout-stamp', 'shop', ['server-array-ledger-char'], 'Tebex transaction id credited exactly once by the purchase webhook'),
    ...
    f('echoesOfWar', 'character', 'server-owned', 'card-clash', ['server-mirror-char', 'combat-strip-char'], 'Echoes of War campaign record (per-encounter wins + first-clear stamps) — card-clash/ai-move echoes settle only'),
    f('echoesWitnessChoices', 'character', 'server-owned', 'card-clash', ['server-mirror-char', 'combat-strip-char'], 'Echoes of War witness decisions — bounded, first-answer-wins records written only by card-clash/echoes-witness'),
    f('echoesStorySeen', 'character', 'client-state', 'card-clash', [], 'Echoes of War story-seen display flags — cosmetic, client-owned'),
    ...
    f('storyChoices', 'character', 'client-state', 'story', ['combat-strip-char'], 'bounded immutable narrative decisions; never reward proof'),
    f('storyScene', 'character', 'client-state', 'story', ['combat-strip-char'], 'bounded unfinished VN cursor/history'),
    f('pendingStoryReports', 'character', 'client-state', 'story', ['combat-strip-char'], 'bounded interlude/road reconciliation queue'),
    f('storyEpilogues', 'character', 'client-state', 'story', ['combat-strip-char'], 'bounded pending/seen finale aftermath receipts; never combat proof'),
