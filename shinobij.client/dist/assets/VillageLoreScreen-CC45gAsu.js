import{i as e,t}from"./react-vendor-CnZExXRc.js";import"./index-eOr9W1ei.js";var n=e(),r={"Ashen Leaf Village":{icon:`🔥`,theme:`The Traditional Path`,lore:`Born from the remnants of a world once consumed by fire, Ashen Leaf rose where devastation met renewal.
...
To choose Moonshadow is to rely on no one… and ensure no one can ever control you.`}},i=t();function a({character:e,onBack:t,onContinue:a}){let o=r[e.village]??{icon:`⚔`,theme:`The Shinobi Path`,lore:`Your shinobi journey begins here.`},[s,c]=(0,n.useState)(``),[l,u]=(0,n.useState)(!1);(0,n.useEffect)(()=>{if(l){c(o.lore);return}c(``);let e=0,t=setInterval(()=>{e++,c(o.lore.slice(0,e)),e>=o.lore.length&&clearInterval(t)},12);return()=>clearInterval(t)},[e.village,o.lore,l]);let d=s.length>=o.lore.length;return(0,i.jsxs)(`div`,{className:`card cinematic-card village-lore-screen`,children:[(0,i.jsxs)(`h1`,{children:[o.icon,` `,e.village]}),(0,i.jsx)(`h3`,{children:(0,i.jsx)(`em`,{children:o.theme})}),(0,i.jsxs)(`div`,{className:`village-lore-text`,onClick:()=>{d||u(!0)},style:{cursor:d?`default`:`pointer`},children:[s.split(`
`).map((e,t)=>(0,i.jsx)(`p`,{children:e},t)),!d&&(0,i.jsx)(`p`,{className:`hint`,style:{opacity:.6,marginTop:8},children:`(tap to reveal)`})]}),(0,i.jsxs)(`div`,{className:`menu`,children:[(0,i.jsx)(`button`,{onClick:t,children:`Choose Another Village`}),(0,i.jsx)(`button`,{onClick:a,className:`admin-button`,children:`Begin Journey`})]})]})}export{a as VillageLoreScreen};