...
export const COMBAT_VFX_ASSETS: Record<CombatVfxKey, CombatVfxAssetSpec> = {
    fire: asset("fire.webp", "ninjutsu", "element", "burst", ["Element: Fire", "Offense: Ninjutsu"]),
    water: asset("water.webp", "ninjutsu", "element", "ground", ["Element: Water", "Offense: Ninjutsu"], 1.52, -2),
    wind: asset("wind.webp", "ninjutsu", "element", "burst", ["Element: Wind", "Offense: Ninjutsu"], 1.5, -1),
    lightning: asset("lightning.webp", "ninjutsu", "element", "ground", ["Element: Lightning", "Offense: Ninjutsu"], 1.48, -1),
    earth: asset("earth.webp", "ninjutsu", "element", "ground", ["Element: Earth", "Offense: Ninjutsu"], 1.42, 0),
    blood: asset("blood.webp", "ninjutsu", "element", "burst", ["Element: Blood", "Offense: Ninjutsu"], 1.5, -2),
    shadow: asset("shadow.webp", "ninjutsu", "element", "burst", ["Element: Shadow", "Control: Shadow"], 1.5, -3),
    poison: asset("poison.webp", "ninjutsu", "element", "ground", ["Element: Poison", "Tag: Poison"], 1.45, 0, 0.84),
    magma: asset("magma.webp", "ninjutsu", "element", "ground", ["Element: Magma", "Element: Lava"], 1.48, -1),
    metal: asset("metal.webp", "ninjutsu", "element", "ground", ["Element: Metal", "Element: Iron"], 1.38, 0),
    slash: asset("slash.webp", "taijutsu", "physical-offense", "slash", ["Offense: Taijutsu", "Hit: Slash"], 1.46, -4),
    ...
    spark: asset("spark.webp", "genjutsu", "control", "ground", ["Tag: Stun", "Tag: Lag", "Tag: Overclock"], 1.4, 0),
    ...
    buff: asset("buff.webp", "support", "support", "ward", ["Tag: Increase", "Support: Buff"], 1.44, -5, 0.84),
