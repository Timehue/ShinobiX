...
export const SPIRE_BOSS_META: Record<SpireBossKey, SpireBossMeta> = {
    warden: {
        ...
        blurb: "Takes half damage while its guards stand. Break the guards, then the wall.",
    ...
    revenant: {
        ...
        blurb: "Heals itself every round. Out-damage the healing or the fight stalls.",
    ...
    ravager: {
        ...
        blurb: "Summons more enemies at every phase. Control the adds or be overwhelmed.",
    ...
    sovereign: {
        ...
        blurb: "Hits harder as its HP drops. Finish it before it peaks.",
