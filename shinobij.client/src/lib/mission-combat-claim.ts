...
// Compatibility exports for existing callers. Account controls load with Settings.
export { deleteServerAccount, DELETE_ACCOUNT_ERRORS, type AccountDeletionResult } from "./account-deletion-client";
