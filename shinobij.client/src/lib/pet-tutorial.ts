...
export const PET_TUTORIAL_LESSONS: readonly PetTutorialLesson[] = [
    ...
    },
    {
        ...
        shortTitle: "Warfront",
        summary: "Deploy four roles across three sealed lanes, earn Favor, time redirects, and break two Ward Towers.",
        practiceLabel: "Open Warfront command",
        destination: { kind: "arena", view: "tactical" },
        pages: [
            {
                kicker: "Lesson 6 · Objective",
                title: "Kills create openings; towers win",
                body: "Warfront is a four-pet command battle across three sealed lanes. The first commander to break two enemy Ward Towers wins. Pets auto-fight by role, so your work is deployment, formation, doctrine, redirects, and command timing.",
                points: [
                    "A 2–1–1 opening contests every lane without pretending every lane is equal.",
                    "Defenders hold, sages sustain, trackers pressure, and assassins hunt vulnerable back lines.",
                    "Do not chase a knockout away from the structure that actually scores the match.",
                ],
                callout: "Tomoe: ‘Four beasts make noise. A commander makes that noise arrive at one tower together.’",
            },
            {
                kicker: "Lesson 6 · Loadout",
                title: "Formation changes behavior; doctrine changes the team",
                body: "Your opening formation controls field behavior. Your doctrine grants a permanent team-wide edge. Read the synergy sentence shown beneath the choices—some pairings accelerate the same plan, while others give a safer fallback.",
                points: [
                    "Siege plans favor structure pressure; defensive plans buy time and lane stability.",
                    "A doctrine should support what the formation asks pets to do most often.",
                    "The saved loadout follows your account, but you should still review it before launch.",
                ],
            },
            {
                kicker: "Lesson 6 · Command windows",
                title: "Redirects are scarce, so move the reason",
                body: "You can redirect one pet only when the command window opens. Move a pet to create an outnumbered push, rescue a collapsing tower, or free the correct role to answer a threat. Random motion wastes the cooldown and weakens two lanes at once.",
                points: [
                    "Read lane health and tower pressure before moving anyone.",
                    "Move the pet whose role solves the destination problem.",
                    "After redirecting, allow time for the new numbers to matter before changing the plan again.",
                ],
            },
            {
                kicker: "Lesson 6 · Favor",
                title: "Combat earns the Gate Warden",
                body: "Your team earns Favor through combat. During a command window, enough Favor can summon the Gate Warden for a major push. Build toward the summon without surrendering a tower while staring at the meter.",
                points: [
                    "Favor is leverage, not the win condition.",
                    "Summon where the Warden converts pressure into a broken tower.",
                    "Two towers end the match—secure the second instead of padding the battlefield.",
                ],
            },
        ],
    },
