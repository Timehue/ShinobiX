...
const RUMORS: Record<string, string[][]> = {
    ...
    village: [
        ...
        ["The lantern-warden marks doors on her rounds. The boy who lights the street lamps says yours is the first she marks every night. He asked her why once. She didn't answer.",
         "The oldest elder set an extra chair at the long table and won't say who it's for. It faces your street. Everyone noticed."],
    ...
    pets: [
        ["The kennel master says the wild ones settle down when your beast walks past. He's stopped trying to explain it. He just points now.",
         "A tamer at the colosseum asked me what you feed yours. Wouldn't believe it's the same feed as everyone else. It is, right?"],
        ["The neighbors keep count of the strays that follow you home. Three last week. One of them, nobody could even name the breed.",
         "The colosseum sand crew says the other beasts line up at the fence when yours fights. They don't pace or growl. They just watch."],
        ...
        ["The blank-map man asked the kennel master which beast around here chose its person instead of the other way around. He walked out with your pet's name.",
         "The colosseum's oldest handler says the beasts fight cleaner when yours is watching. Like they're auditioning. His word, not mine."],
        ["The old man with the staff stood at the colosseum fence for all three of your beast's fights. Your beast watched him right back. Neither one blinked.",
