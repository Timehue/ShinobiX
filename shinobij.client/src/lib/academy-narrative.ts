...
export const ACADEMY_VOWS: readonly AcademyVowDefinition[] = [
    {
        ...
        shiranuiResponse: "Good. When the Gate offers you a shape, make it learn the difference between refusal and emptiness.",
        companionCallback: "You chose your own name once already. If the road tries to rename you, I'll remind you.",
