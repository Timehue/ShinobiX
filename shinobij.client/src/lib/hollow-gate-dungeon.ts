...
// Room-flood visibility moved to ./hollow-gate-visibility so the always-loaded
// walker/map-memory path can use it without dragging this generator (ASCII
...
// hollowGatePetEncounterSeed moved to ./hollow-gate-run so the always-loaded
// Hollow Gate flow can seed a sealed duel without loading this generator.
export { hollowGatePetEncounterSeed } from "./hollow-gate-run";
