...
export const villageUpgradeDefinitions: Array<{
    ...
    description: string;
        ...
        { key: "training", name: "Training Grounds", icon: "💪", perLevel: 0.25, unit: "%", description: "+0.25% stat gain from stat training per level." },
        ...
        { key: "missionHall", name: "Mission Hall", icon: "📜", perLevel: 0.5, unit: "%", description: "+0.5% stat points, ryo, and stamina from mission rewards per level." },
