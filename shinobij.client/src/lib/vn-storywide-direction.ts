...
import { storyLeadershipPortrait } from "../data/storywide-leadership-portraits";
...
export const STORYWIDE_ACTORS: Record<string, string> = {
    "mira volt": storyLeadershipPortrait("mira volt"),
    "kage raiko veyr": storyLeadershipPortrait("kage raiko veyr"),
    "raiko veyr": storyLeadershipPortrait("kage raiko veyr"),
    ...
    "hoshina enju": storyLeadershipPortrait("kage hoshina enju"),
    ...
    "kael whitefang": storyLeadershipPortrait("kage kael whitefang"),
    "elder sova": storyLeadershipPortrait("elder sova"),
    nyx: storyLeadershipPortrait("nyx"),
    ...
    "kage sable nocturne": storyLeadershipPortrait("kage sable nocturne"),
    "sable nocturne": storyLeadershipPortrait("kage sable nocturne"),
...
export const STORYWIDE_ACTOR_VARIANTS: Record<string, Partial<Record<VnActorPose, string>>> = {
    ...
    "mira volt": {
        neutral: storyLeadershipPortrait("mira volt", "neutral"),
    ...
    nyx: {
        neutral: storyLeadershipPortrait("nyx", "neutral"),
        tense: STORYWIDE_ACTORS.nyx,
        resolute: "/portraits/cinematic/storywide/nyx-resolute.webp",
    },
    "kage sable nocturne": {
        neutral: storyLeadershipPortrait("kage sable nocturne", "neutral"),
        tense: storyLeadershipPortrait("kage sable nocturne", "neutral"),
    },
    "sable nocturne": {
        neutral: storyLeadershipPortrait("kage sable nocturne", "neutral"),
        tense: storyLeadershipPortrait("kage sable nocturne", "neutral"),
