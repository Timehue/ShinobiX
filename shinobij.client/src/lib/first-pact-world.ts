...
export type FirstPactNpcDefinition = Readonly<{
    ...
    portrait: "keeper" | "registrar" | "scribe" | "merchant" | "engineer" | "citizen" | "arbiter";
}>;
...
export const FIRST_PACT_ARCHITECTURE: readonly FirstPactArchitecturePlacement[] = [
    ...
    { id: "gateworks-cistern-head", atlasCell: 13, bounds: { x: 67, y: 48, width: 3, height: 3 }, // The canopy and its posts are visual overhang; only the stone kerb is solid.
        collisionMask: ["...", "...", "###"] },
    { id: "gateworks-valve-house", atlasCell: 14, bounds: { x: 74, y: 47, width: 4, height: 4 }, collisionMask: [".##.", "###.", "####", "...."] },
...
export const FIRST_PACT_CITY_PROPS: readonly FirstPactPropPlacement[] = [
    ...
    { id: "stable-hay-cart", atlasCell: 10, bounds: { x: 6.45, y: 40.2, width: 2.6, height: 1.73 }, rotation: -4 },
    ...
    { id: "gateworks-store-crates", atlasCell: 9, bounds: { x: 66.4, y: 45.55, width: 2.4, height: 1.4 } },
...
export const FIRST_PACT_NPCS: readonly FirstPactNpcDefinition[] = [
     ...
     *
     * Every other person in this city is something the Court is doing to
     * someone. The campaign's antagonist was an institution the player never
     * met, argued with, or heard speak, and the Balancing was four rounds
     * against a roster with no face behind it. The Arbiter is that face.
     *
     * Placed at the mouth of the council annex rather than on its threshold at
     * (51, 11): standing on the door would hide it, and the annex is enterable.
     * Facing west puts the Court looking straight across the square at Vey's
     * archive, which is the one thing in the city it cannot edit.
     */
    { id: "court-arbiter", name: "The Arbiter", title: "Voice of the Balanced Court", position: { x: 52, y: 12 }, behavior: "static", facing: "west", palette: "slate", portrait: "arbiter" },
