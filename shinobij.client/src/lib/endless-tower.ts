 ...
 * These helpers are display-only previews. Opponent choice/scaling and every
 * economy mutation are authoritative in api/endless.
 */
...
// Non-multiples of 5 return zero. This mirrors the authoritative server math
// for previews and tests; the server alone credits the reward.
