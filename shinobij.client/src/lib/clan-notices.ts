...
export function normalizeNoticePosts(posts?: Partial<NoticePost>[], legacyNotices: string[] = [], limit = 24): NoticePost[] {
    ...
    return [...structured, ...legacy].sort((a, b) => Number(Boolean(b.pinned)) - Number(Boolean(a.pinned)) || b.createdAt - a.createdAt).slice(0, limit);
}
