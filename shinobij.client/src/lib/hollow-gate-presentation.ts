...
const FLOOR_PROFILES: readonly HollowGateFloorProfile[] = Object.freeze([
    {
        ...
        epithet: "Where the shrine stopped welcoming pilgrims",
        atmosphere: "Ash drifts through a torii split by something that entered from below.",
        lore: "Fresh claw marks cross older pilgrim names. The first ward did not fail—it was opened.",
        houndName: hollowGateHoundName(1),
        houndEpithet: "Ashfang, Keeper of the First Ward",
        signature: "Cinder Pounce",
        storyTitle: "The Pilgrim Roll",
        storyEcho: "A singed register lists every pilgrim who crossed the threshold. The final name was carved from the other side.",
        ...
        petTrace: "Violet pawprints end at a child-sized pilgrim sandal, untouched by the ash.",
        accent: "#d97745",
