...
export const starterItems: GameItem[] = [
    ...
    { id: "bulwark-gloves", name: "Eternal Bulwark's Gauntlets", slot: "hand", rarity: "legendary", cost: 150, description: "Reinforced gauntlets that convert a portion of damage received into HP.", levelReq: 40, weaponCooldown: 5, bonuses: { ninjutsuOffense: 75, taijutsuOffense: 75, bukijutsuOffense: 75, genjutsuOffense: 75, ninjutsuDefense: 30, taijutsuDefense: 30, bukijutsuDefense: 30, genjutsuDefense: 30, absorbPercent: 1 } },
    ...
    { id: "crimson-gloves", name: "Crimson Tide Gauntlets", slot: "hand", rarity: "legendary", cost: 150, description: "Bloodstained gauntlets that siphon life with every strike.", levelReq: 40, weaponCooldown: 5, bonuses: { ninjutsuOffense: 75, taijutsuOffense: 75, bukijutsuOffense: 75, genjutsuOffense: 75, ninjutsuDefense: 30, taijutsuDefense: 30, bukijutsuDefense: 30, genjutsuDefense: 30, lifeStealPercent: 1 } },
    ...
    { id: "ironwall-gloves", name: "Ironwall Gauntlets", slot: "hand", rarity: "legendary", cost: 150, description: "Fortress-grade gauntlets that manifest a protective barrier at battle's start.", levelReq: 40, weaponCooldown: 5, bonuses: { ninjutsuOffense: 75, taijutsuOffense: 75, bukijutsuOffense: 75, genjutsuOffense: 75, ninjutsuDefense: 30, taijutsuDefense: 30, bukijutsuDefense: 30, genjutsuDefense: 30, shield: 100 } },
    ...
    { id: "mirror-gloves", name: "Mirror Soul Gauntlets", slot: "hand", rarity: "legendary", cost: 150, description: "Reflective gauntlets that bounce a fraction of each strike back to the enemy.", levelReq: 40, weaponCooldown: 5, bonuses: { ninjutsuOffense: 75, taijutsuOffense: 75, bukijutsuOffense: 75, genjutsuOffense: 75, ninjutsuDefense: 30, taijutsuDefense: 30, bukijutsuDefense: 30, genjutsuDefense: 30, reflectPercent: 1 } },
