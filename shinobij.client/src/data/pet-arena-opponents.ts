...
export const genericPetArenaOpponents: PetArenaOpponent[] = [
    {
        ...
        pet: applyPetTraitBonuses({
            ...
            jutsus: [
                ...
                { name: "Tempest Featherstorm", power: 62, cooldown: 5, currentCooldown: 0, kind: "damage", signature: true },
    ...
    },
    {
        ...
        pet: applyPetTraitBonuses({
            ...
            jutsus: [
                ...
                { name: "Iron Bastion",    power: 90, cooldown: 5, currentCooldown: 0, kind: "barrier", signature: true },
    ...
    },
    {
        ...
        pet: applyPetTraitBonuses({
            ...
            jutsus: [
                ...
                { name: "Inferno Pounce",  power: 90, cooldown: 4, currentCooldown: 0, kind: "damage", signature: true },
            ],
            unlockedForPve: true,
            trait: "Aggressive",
        }, "Aggressive"),
