/*
 * Per-village lore text shown on the Village Lore screen (screens/
 * VillageLoreScreen). Pure data, no imports. Extracted verbatim from App.tsx
 * and re-exported from there for the existing "../App" import site.
 */
