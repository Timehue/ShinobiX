...
const wildPetFlavor: Record<string, string> = {
    ...
    // ── Legendary ──
    "Glacier Wolf": "Runs the high ice alone. Herders find its prints circling the camp, but never inside it.",
    "Tempest Hawk": "Rides the drafts ahead of the lightning. Falconers gave up on the lure. Only bad weather brings it down.",
    ...
    "Vermillion Suzaku": "The south wind's firebird. Its molted feathers never cool, and the coliseum keeps one burning as its eternal flame.",
