...
export const storyRoadEvents: StoryRoadEvent[] = [
    ...
    roadEvent(66, "fifth-anchor", "The Fifth Anchor", "Corvo Latch", "broker", [
        ...
        ch("Walk the galleries, chart them, take the map to the Sage", "neutral", "rd66-carried-the-map", "Three days of pacing and counting turns by lamplight. The Wandering Sage unrolls the map without surprise, rests a finger on the sleeping faces, and asks who else has copies.", undefined),
    ...
    roadEvent(74, "four-seals-one-gate", "Four Seals, One Gate", "The Wandering Sage", "pilgrim", [
        pg("Chalk Marks", "A crossroads shrine north of Central", "The Wandering Sage",
        ...
        pg("One Lattice", "The crossroads shrine, after dark", "The Wandering Sage",
        ...
        pg("What Keys Are For", "Firelight, four keys on stone", "The Wandering Sage",
