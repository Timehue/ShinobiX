...
export const storyRoadEvents: StoryRoadEvent[] = [
    ...
    roadEvent(34, "withheld-cache", "What the Withheld Kept", "Serel", "emissary", [
        ...
        pg("Three Dry Days", "Inside the moss ring, midday", "Serel",
            ...
            "The stone knows not-having from not-taking. Going hungry is not enough. It opens for someone who chooses not to take what they could have taken. Anholt made me learn that thirsty, so I teach it thirsty.",
        ...
        ch("Refuse tonight's meal and wait at the seam", "good", "rd34-kept-my-no", "At dusk the seam parts on a slate of names, each beside the one thing its owner kept. You read until the light goes and set it back. Before the seam closes, a second mark surfaces beside where your hands rested: not a name, not a Bloodline sign, something the stone remembers that you do not. 'That was not only your refusal it recognized,' Serel says, cutting a fresh notch in her staff. 'Something older answered with you.'", undefined),
    ...
    roadEvent(44, "legacy-without-a-name", "A Legacy Without a Name", "Emissary Corvane", "emissary", [
        pg("The Stone at the Fork", "A marker stone where three roads meet", "Emissary Corvane",
            ...
            "People call a Legacy an ancestor's gift. That is too kind. The old Hollow Gate civilization learned how to take the part of a Bloodline that endured hardest and make it survive the person. Sometimes the strongest part. Sometimes the noblest. Sometimes the worst thing in them.",
            "The body dies. That piece keeps moving through the family. Not the whole ancestor. Not a second Bloodline. One piece they left behind. A gift, a wound, or both.",
            "Her line still carries one of hers, sleeping. It waits for a descendant it fits; most never come. Which piece it is depends on which of the three accounts is true, and there is no name left on any of them.",
        ...
        pg("The Open Register", "The register hall in Ashen Leaf, after hours", "Emissary Corvane",
            ...
            "And understand what you are weighing. Your Bloodline is the family river. A Legacy is one old thing inside it that never washed away. You are not choosing what Isa Renn did. You are choosing which piece of her the river keeps carrying.",
    ...
    roadEvent(48, "unsworn-ledger", "The Unsworn's Ledger", "Kite Harrow", "rival", [
        ...
        ch("Break the seal with her; split the penalty", "good", "rd48-split-the-penalty", "Inside: stacked clay tallies, each stamped with a living person's name and the words 'received in full.' And under the tallies, one older slab in a script that predates every village, marking each family line twice: a status word, LEGACY-BEARING or DORMANT or LINEAGE UNCONFIRMED, and one trait word beside it. 'This is not a Bloodline registry,' Harrow says slowly. 'Bloodline books list families, abilities, births. This lists one trait per line. Strongest. Cruelest. Most loyal. Somebody was choosing what part of a person would survive them.' She copies every name into her ledger, then nails the manifest to the waystation board for anyone to read.", undefined),
    ...
    roadEvent(66, "fifth-anchor", "The Fifth Anchor", "Corvo Latch", "broker", [
        ...
        pg("The Court Below", "First gallery, below the winch", "Narrator",
            ...
            "Under the words, columns of tallies. Each column is headed by a small carved face, and every face is asleep. Down one wall, family lines are cut generation by generation, and every person's name ends. One small mark beside the names does not end. It keeps passing from parent to child, all the way down the wall, and out past the lamplight.",
    ...
    roadEvent(74, "four-seals-one-gate", "Four Seals, One Gate", "Wandering Sage", "pilgrim", [
        ...
        pg("One Lattice", "The crossroads shrine, after dark", "Wandering Sage",
            ...
            "My ancestors refused the Court's bargain. Before they fled, they recorded where its four locks were buried. Not hope. Bookkeeping.",
            "The Court did one more thing, and you should hear it from a keeper and not a machine. It marked the Bloodlines that could survive contact with its network, and from those lines it preserved one dominant inheritance apiece. It called them Legacies. The villages changed. The Bloodlines changed. The old machines still recognize the pieces the Court left inside certain families.",
            "And these keys warmed faster for you than they ever did for me. Somewhere up your line, somebody carried something the Court preserved on purpose. A dormant Legacy looks exactly like that from the outside: an old answer waiting for a new person to decide what it means. If anything ever offers to name it for you, remember that it's yours to refuse.",
