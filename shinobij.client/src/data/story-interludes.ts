...
export const storyInterludesByVillage: Record<string, StoryInterlude[]> = {
    "Stormveil Village": [
        ...
        interlude("Stormveil Village", 70, "The Scheduled Loss", [
            ...
            pg("The Third Exchange", "The arena, main card, Pike across the chalk, the script in everyone's pocket but yours", "Joren Pike",
                ...
                "The office runs people by taking the why out of them. You've still got yours, so their slate doesn't get to decide this one.",
        ...
        interlude("Stormveil Village", 88, "The Quiet Storm", [
            ...
            { ...pg("The First Raise", "The spine cable rising against the storm's first arm, everything singing", "Narrator",
                ...
                choices: [
                    { text: "\"Back on the roof I asked what your boat route was worth, like I meant to sell it. I'm sorry. I won't do that again.\"", nextPage: 3, requireTrait: "mira-fear", trait: "sv88-repaired-trust" },
            ...
            { ...pg("Knots Under Torsion", "The third anchor, the two of you alone with the failed splice", "Mira Volt",
                ...
                "You asked what my way out was worth like you meant to sell it. I moved the bag back to the hatch that night, and it's been there since. The stupid part is that you were the reason I'd started moving it away.",
                "I can't tell you we're square. I can tell you what I need right now, which is your hands on this cable while I splice it her way.",
            ...
            { ...pg("You Hold the Sky", "The mast foot, Mira wrapping the slate in oilcloth with rigger's care", "Mira Volt",
                "Good. Then I carry her, and you hold the sky. Don't make a face. Holding the sky is the bigger job, and after a whole night of it my arms are done.",
        ...
        interlude("Stormveil Village", 92, "Witnesses", [
            ...
            { ...pg("The Name on the Mast", "The switchback, the spyglass passed hand to hand", "Elder Vanta",
                ...
                "Ha! Oh, that's better than evidence, child. Evidence argues. A name on a mast testifies, all day, every day, to everyone who looks up.",
    ...
    "Ashen Leaf Village": [
        ...
        interlude("Ashen Leaf Village", 42, "Pruning Season", [
            ...
            ch("Copy the wall's outlines tonight, exact and to scale.", "good", "al42-filed-a-report", "Every shadow, measured and dated, with no names on the page and nothing the survey could hold against her. Toma watches your steady hand and says, quietly, 'The dead should hire you.' Aren has a second document now."),
            ...
            ch("Chip one painted outline off the wall as hard proof.", "bad", "al42-burned-a-blank", "A palm-sized flake of cream paint and shadow, wrapped in a napkin: proof you can carry and use, and nothing she can be blamed for. On the way out, Sera hugs you and thanks you for listening. The napkin feels heavier after that."),
        ]),
        ...
        interlude("Ashen Leaf Village", 88, "The Wet Field", [
            { ...pg("The East Channel", "The east terrace channel at night, lamplight on low water", "Toma Reed",
                ...
                "The working reconstruction is in my coat, built from the surviving joint, the marks behind Aren's bench, and what Jorun's hands remember. It isn't Aren's own piece. The full frame is in the channel.",
            ...
            { ...pg("You Carry the Door", "The channel bank, Toma holding the model", "Toma Reed",
                ...
                "Thank you. That's the whole speech I've got, and the rest we'll say to her."),
                choices: [
            ...
            { ...pg("Grateful Is Not Ready", "The channel bank, the model still in your own hands", "Toma Reed",
                "You saved the reconstruction from the squad. That matters, and I won't pretend it makes this easy.",
        ...
        interlude("Ashen Leaf Village", 92, "Witnesses", [
            ...
            { ...pg("The Signatures", "His thumb on the carved housing plate", "Elder Mori",
                ...
                "Charts can be argued with, child. Names can't. A machine with names on it stops being a rumor and becomes somebody's word, given in public, on purpose.",
    ...
    "Frostfang Village": [
        ...
        interlude("Frostfang Village", 58, "Sova's Cut", [
            ...
            { ...pg("Ninety Winters", "The records room, two ledgers open side by side", "Narrator",
                ...
                "The curve is patient and terrible. Each decade, the vault needs a little more doubt for the same warmth. The Count answers with more checks, deeper marks, longer holds at the plate. The machine isn't failing. It's hungry, and it gets hungrier every year.",
        ...
        interlude("Frostfang Village", 70, "The Mark That Stays Warm", [
            ...
            { ...pg("A Debt to Pay, Audited", "The antechamber, your intake line copied out in Vess's file", "Narrator",
                ...
                "You may still owe someone gratitude. You don't owe this vault obedience. Frostfang didn't perform that rescue, and the Count has no right to collect on it."),
                choices: [
                    { text: "The ledger line.", nextPage: 7 }
                ] },
        ...
        interlude("Frostfang Village", 88, "The Long Lanterns", [
            ...
            { ...pg("The First Line Fails", "The search line, lanterns guttering, oil thickening in the cold", "Narrator",
                ...
                choices: [
                    { text: "\"I pushed you once about who pulled you off this ridge. I shouldn't have. I won't ask again.\"", nextPage: 3, requireTrait: "yura-fear", trait: "ff88-repaired-trust" },
            ...
            { ...pg("Fear, Retired", "The third stake, the two of you relighting the same lamp", "Captain Yura",
                ...
                "You pushed me about who saved me. Then you spent a month posted south, and you never once used what you knew about my floorboard against me. I noticed that too.",
                "The south posting was the punishment, and that's done. It isn't everything between us. But it's done.",
    ...
    "Moonshadow Village": [
        ...
        interlude("Moonshadow Village", 30, "One True Thing", [
            ...
            ch("\"Partners. Your verification, my reach. Profits and risks split even.\"", "good", "nyx-partner", "She flips the not-coin once and lets it lie where it lands. Then she writes a contract on a verification slip, three lines, even on both sides, and signs it with her working name. 'Partners,' she says. 'The stall's first.' She puts the not-coin in a drawer and shuts it."),
        ...
        interlude("Moonshadow Village", 42, "The Cold Pipe", [
            ...
            pg("Following It Down", "The house's maintenance crawl, the pipe descending in the dark", "Narrator",
                "You skip the courier bell. Some packets can wait, and some pipes cannot.",
        ...
        interlude("Moonshadow Village", 58, "Iro's Cut", [
            ...
            ch("\"Keep the shelf. I'd rather be read than become a reader.\"", "good", "ms58-refused-the-shelf", "Iro looks at you for a long moment and laughs. 'One of very few refusals in my private book.' He writes your name beneath the others. 'Do keep me informed of your health,' he says. 'I dislike losing rare data points.'"),
        ...
        interlude("Moonshadow Village", 88, "The Returning", [
            ...
            { ...pg("The First Return", "The booth at moonrise, one subject summoned, one file on the table, the market pretending not to watch", "Narrator",
                ...
                choices: [
                    { text: "\"I bought the trainee's reports about me instead of asking you what you knew. That was the wrong way round. I'm done with it.\"", nextPage: 2, requireTrait: "nyx-suspicion", trait: "ms88-repaired-trust" },
            ...
            { ...pg("Fear, Refunded", "The booth's shadow, Nyx very still, the market noise far away", "Nyx",
                ...
                "Sit at the table with him. If he walks out of here with his own file and nobody hurt, we're not square. But it's a start.",
            ...
            { ...pg("You Hold the Market", "The booth, Nyx wrapping her own file in plain paper, like any parcel", "Nyx",
                ...
                "My mother gave me a name. The market sold it. Sable can hear me claim it without offering anything back. If my voice goes, Sable can wait until Nerissa finishes."),
                choices: [
