...
export const storyInterludesByVillage: Record<string, StoryInterlude[]> = {
    "Stormveil Village": [
        ...
        interlude("Stormveil Village", 80, "Harrow's Shortcut", [
            ...
            { ...pg("The Counter That Makes Offers", "The cistern ledge: a vast dark reserve, and a stone counter worn smooth by centuries of bargains", "Kite Harrow",
                "There. The hum in your teeth is four villages' worth of taken reasons, banked. And that stone slab is the counter. You put a thing on it and the dark makes you an offer. Everyone down here before us has traded SOMETHING; the stone's worn like a moneylender's step.",
    ...
    "Frostfang Village": [
        interlude("Frostfang Village", 20, "The Unsworn", [
            pg("Hazard Pay", "Second roll call, a bare-wristed woman leaning on the count stone", "Kite Harrow",
                "You're staring at my wrist. Everyone does. Bare as a baby's, isn't it. I'm contract. Central license. The count pays me DOUBLE, and do you know what the line item says? Hazard pay.",
                "The hazard is that I can leave. That's it. That's the hazard. I can walk away mid-job, so I cost twice a marked soldier who can't. You're new enough that your face still works; look at your face hearing that.",
                "This village will pay anything except the risk of somebody choosing to stay.",
                "I've worked all four anchors, little intake. Everywhere prices something strange. Here they price the door."),
            { ...pg("The Outside View", "The wall walk, lantern lines humming overhead", "Kite Harrow",
                "Free tour, since you carry my kit like a professional. That litany they sang at your intake. Checked, counted, kept, warm. Pretty. Now watch what it DOES.",
                "Gate check: wrists, not faces. Roll call: names, not people; a corrected man answers just fine, I've heard one. Rescue law: triggered by the mark, not the missing. Every beautiful promise, automated until nobody has to mean it.",
                "In Stormveil they launder anger. Here? They've industrialized DEVOTION. Same plumbing. Better hymns.",
                "And the vault under it all buys one thing only. Not loyalty, they have plenty. It buys the moment you'd have left. Remember I said that. It'll rhyme later."),
                choices: [
        ...
        interlude("Frostfang Village", 30, "The Ridge Roll", [
            ...
            pg("The Struck Roll", "The tower rail, four names said into falling snow", "Captain Yura",
                "Solvei. Present in the gloves on my hands; she knitted them on day four and made fun of my stitches. Brahm. Present in every kit check I run too hard. Ketta. Present. She sang. I don't. That's how she's present.",
                "Dren Coldewe. Present... somewhere. He walked out on day six and the count says deserter, and on day nineteen SOMEBODY dragged me off that ridge, and command logged it self-recovery, and I let them, because I was young and grateful and the litany doesn't have a verse for miracles with no mark on them.",
                "And then my own name. I answer it last, every month. Because a post roll isn't done until every name answers, and for nineteen days, mine didn't. Nobody's did. That's what OUTSIDE the count means, and I hold the memory of it the way you hold a burn.",
            ...
            pg("What You Do With Knowing", "The tower, the roll book closing, snow easing", "Captain Yura",
                "So. My captain thinks I'm the count's truest believer. Sova thinks I'm her best argument. Kael pinned my rank on personally, twice.",
                "And the truth is I'm a woman who does an illegal roll call for the dead once a month and answers her own name at the end so the silence doesn't win.",
                ...
                "Say something, intake. Whatever it is, say it plain. I've had a lifetime of cadence."),
        ], [
        ...
        interlude("Frostfang Village", 58, "Sova's Cut", [
            { ...pg("The Records Room", "Sova's records room, ledgers to the ceiling, the vault's meter humming in the floor", "Elder Sova",
                ...
                "You've earned the plain version, so here it is. The vault keeps this village warm. It runs on the count. Every marked wrist that obeys while doubting pays a toll: the doubt goes down, the warmth comes up. Ninety years, zero frozen children. That's the trade, and I have kept its books my whole life.",
                "Every wrist but two. Look.",
                "Bare. Both of them. The keeper stands OUTSIDE the count. Someone has to read the meter without being read by it. That's the exemption, and it comes with the books, and I am offering you both, because I am old and the meter is climbing and my successor should be somebody the plate can't already taste."),
                choices: [
            ...
            { ...pg("Ninety Winters", "The records room, two ledgers open side by side", "Narrator",
                ...
                "'Now you've read what I read every night,' she says. 'The litany got ninety years of children through the cold. And it has perhaps six more before it must eat the whole flock to warm the barn.'"),
                choices: [
        ...
        interlude("Frostfang Village", 70, "The Mark That Stays Warm", [
            ...
            { ...pg("The Watch Why, Audited", "The antechamber, your intake line copied out in Vess's file", "Narrator",
            ...
            { ...pg("The Spine Why, Audited", "The antechamber, your intake line copied out in Vess's file", "Narrator",
            ...
            { ...pg("The Debt Why, Audited", "The antechamber, your intake line copied out in Vess's file", "Narrator",
            ...
            { ...pg("The Door Why, Audited", "The antechamber, the fogged plate still holding its struck name", "Narrator",
            ...
            { ...pg("The Blank Why, Audited", "The antechamber, Sova's dragged pen-line copied in the file", "Narrator",
            ...
            pg("The Anchor Offered", "The antechamber, the holder-grade mark gleaming on its felt, Yura at the door", "Captain Yura",
                "For the record, I'm ordered to witness, not to advise. So this isn't advice; it's a soldier thinking out loud near you.",
                "That mark binds people to come for you whether they'd choose it or not. I have been on both ends of an unchosen rescue, and I can tell you which end breaks a person.",
                "The Kage calls it an honor. Vess calls it an anchor. I call it my worst night, cast in frost and offered as a prize.",
                "Whatever you do, the count is watching. It fogged your plate twice; it WANTS a handle on you. Decide what it gets."),
        ], [
        ...
        interlude("Frostfang Village", 80, "Harrow's Shortcut", [
            ...
            { ...pg("What Drinks Through It", "The icehouse bench, a forged mark held to the lamp", "Kite Harrow",
                ...
                "My forgeries pass the gate but hold no drink; there's no surrender in them, I just hum the tune. Which means the count has been logging wrists that pay it NOTHING, and it can't tell. It's a bank that can't audit its own coin.",
                "I've sold information to four villages and priced two wars, and I have never held a lever like this bench. A list of every choke point in the count's plumbing, and the skill to counterfeit its currency.",
                "So, my incorruptible anomaly: what would YOU do with a machine's own skeleton key? Because I've been holding three answers all week and I don't like any of mine."),
                choices: [
        ...
        interlude("Frostfang Village", 88, "The Long Lanterns", [
            ...
            { ...pg("Nineteen Minutes", "The full relay burning down the ridge, the search moving lamp to lamp", "Narrator",
                ...
                "They find Essen at the fourth spur, upright, walking his drift line, half a ridge off where the count's models said a lost man drifts. The models assume panic. He wasn't panicking. He was TRUSTED, and he knew it, and trusted men walk straighter.",
                "Nineteen minutes, whiteout to handshake. Yura calls it aloud twice, voice cracking on the second call, and nobody in the line pretends not to hear it: 'Found! By CHOICE, found!'",
        ...
        interlude("Frostfang Village", 92, "Witnesses", [
            ...
            { ...pg("The Camp's Message", "The first cairn, the Pale Pack Runner with frost in her hood", "Pale Pack Runner",
                "Message from Marrin, memorized, so mind the wording; she made me say it back twice.",
                "'If the vault breaks tonight, the Pack comes down at next bell and answers one roll call, freely, in the forecourt. Struck names, standing in the count's own yard, present by choice. Not because we forgive it. Because somebody has to show this village what a count sounds like when every answer is a decision.'",
                "That's the message. Here's my own postscript: I carried a lantern pattern back to the glacier last month. There are forty of them burning up there now. We didn't wait for your drill to believe it, wall-walker. We just waited for someone down here to prove it OUT LOUD.",
            ...
            { ...pg("The Letter Walks Point", "The cairn road, Yura with the letter squared in her breast pocket", "Captain Yura",
                ...
                "His letter, his lantern plans, and one line of his handwriting that outweighs every ledger in Sova's room. That's the whole kit of Dren Coldewe, deserter, and it beats the vault, and I get to say so at the door the count built out of him and me both.",
            ...
            { ...pg("The Log, Read Aloud", "The first cairn, the drill log open between mittened hands", "Pale Pack Runner",
                "Read it to me. I memorize things; it's my whole job. Go slow on the numbers.",
                ...
                "The count taught this whole mountain that belonging is a mark or nothing. One page of honest numbers, and tonight the mountain gets to read the third option.",
            ...
            { ...pg("The Slow Count", "The wall checkpoint, Sergeant Essen counting the road's walkers with theatrical care", "Narrator",
                ...
                "Sergeant Essen stands the post. He counts the walkers one at a time, aloud, with enormous procedural dignity, and the count keeps, somehow, arriving at numbers that require no report. 'Eleven,' he announces, of forty. 'Well within norms.'",
