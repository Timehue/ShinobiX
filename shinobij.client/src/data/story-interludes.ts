    ...
    "Ashen Leaf Village": [
        ...
        interlude("Ashen Leaf Village", 92, "Witnesses", [
            ...
            { ...pg("The Mother", "The road, Sera Reed stepping forward", "Sera Reed",
                "Don't look so alarmed, dear. Toma told me where you'd be walking. He tells me things now. We're practicing that, him and me.",
                "Three nights this week, I've dreamt in handwriting. Aren's handwriting. The real one, with the stubborn loops he never fixed. I wake up furious at people I can't name, and it feels like being handed back a limb I didn't know was gone.",
            ...
            { ...pg("The Keeper of Records", "The road, Mori with a bound book", "Elder Mori",
                ...
                "Do you understand what the signature means? Anyone can dismiss an old man's private counting. Nobody can dismiss the village record keeper putting his name on forty years of evidence. It is the difference between grief and testimony.",
