    ...
    "Ashen Leaf Village": [
        interlude("Ashen Leaf Village", 20, "The Unsworn", [
            pg("The Woman Who Billed for One Day", "Register hall, evening queue", "Toma Reed",
                "That's her. By the credit ledger. The one who brought the grove ledger back.",
                ...
                "Her boots are wrong for grove work. Too clean. She went in by the flood channel, I'd bet a month's pay I don't have.",
                "Sorry. I'm staring. We should not stare. Everyone in this queue is staring and pretending to read the wall."),
            { ...pg("Restoration Credit", "The clerk's window, register hall", "Narrator",
                "At the window, the duty clerk slides a chit across. Kite Harrow slides it back.",
                "One line of restoration credit, the clerk says. Redeemable against any name on the west wall. He says it like a kindness.",
                "Coin, she says. The clerk's stylus stops. Somewhere behind him, a drawer closes.",
                "The queue goes very interested in its own paperwork.",
                "She counts the coin twice at the window, where he has to watch her do it. Then she looks at you."),
                choices: [
                    { text: "Ask her how two days beat the squad's nine.", conclusion: "", trait: "", lane: "neutral" as const, nextPage: 2 },
                    { text: "Ask why she wanted coin, not credit.", conclusion: "", trait: "", lane: "neutral" as const, nextPage: 3 }
                ] },
            { ...pg("Two Days", "The register wall", "Kite Harrow",
                "Your squad quoted nine days because the route sheet says nine days. Procession pace. Stop at every shrine stone, sign at every waypost.",
                "I walked the flood channel at night and read the ledger by candle in the mud. Two days. One of them was waiting for the water.",
                "Nine days is not slowness. Nine days is reverence, priced. Your village charges itself for its own manners.",
                "Don't repeat that to the boy. He's still proud of the route sheet."),
                choices: [
                    { text: "Let the queue move", conclusion: "", trait: "", lane: "neutral" as const, nextPage: 4 }
                ] },
            { ...pg("The Exchange Rate", "The register wall", "Kite Harrow",
                "Coin spends anywhere. Names only spend here. Your clerk offered me a line in this wall like it was a favor.",
                "I checked the oldest plates while I waited. Cedar, all of them, every edge worn round from hands. People touch what they bank.",
                "Somebody set the rate between a name and a winter's grain. It wasn't the clerk. Ask who it was. Ask twice. The first answer is a shrine story.",
                "Anyway. I took the coin."),
                choices: [
                    { text: "Take that in", conclusion: "", trait: "", lane: "neutral" as const, nextPage: 4 }
                ] },
            pg("Staring", "Register hall, lamps going out", "Toma Reed",
                "You talked to her. What did she... no. Don't tell me. Actually, tell me later, when I've stopped rehearsing it.",
                "The clerk is still at the window. He recopies the same line when he's rattled. That's four copies.",
                "She's at the door. If you want to say something, it's now."),
        ], [
        ...
        interlude("Ashen Leaf Village", 30, "Toma's Relic", [
            ...
            { ...pg("In the Lamplight", "The shed, lamp turned low", "Narrator",
                "He sets the plate on the drying rack between you. A cloth goes down first, smoothed twice.",
                "Herbs overhead, dust, a coil of twine on a nail. Everything in this shed has a place it goes back to.",
                "The plate's edges are soft. Somebody worked each corner round by hand, long before any swap.",
                "Toma waits. He has stopped rehearsing, and it shows."),
                choices: [
                    { text: "Ask about the grandmother.", conclusion: "", trait: "", lane: "neutral" as const, nextPage: 2 },
                    { text: "Ask why it can't stay with him.", conclusion: "", trait: "", lane: "neutral" as const, nextPage: 3 }
                ] },
            { ...pg("The Joiner", "The shed", "Toma Reed",
                "She chamfered every edge she ever cut. Said a name should not bite the hand that carries it.",
                "The blank took her one night. Grain matched, weight matched, notch placed by eye. The clerks handled it at the rite and felt nothing.",
                "She never told anyone why. I found the real plate wrapped in her tool roll, after. The chisel was still sharp.",
                "I checked the burn record once. It says the fire drew badly that night. That's all it says."),
                choices: [
                    { text: "Ask what he needs", conclusion: "", trait: "", lane: "neutral" as const, nextPage: 4 }
                ] },
            { ...pg("Three Reasons", "The shed", "Toma Reed",
                "Three reasons it can't stay with me. I wrote them down and burned the list, which tells you something already.",
                "I'm watched since the archive. Not followed. Watched. There's a man at the tea stall who never finishes his tea.",
                "My room was searched in spring. Nothing taken. They left it tidier than they found it, which was worse.",
                "And the third reason is that I look at it too long."),
                choices: [
                    { text: "Ask what he needs", conclusion: "", trait: "", lane: "neutral" as const, nextPage: 4 }
                ] },
            pg("The Ask", "The shed, lamp guttering", "Toma Reed",
                "If it's found on me, it burns, and this time there's no grandmother.",
                "You could say no. Most people would say no.",
                "Sorry. I'm asking you to hold my family in your hands and I'm making it sound like luggage."),
        ], [
        ...
        interlude("Ashen Leaf Village", 42, "The Draw", [
            pg("Letter by Letter", "The burning yard at dusk, full rows", "Narrator",
                ...
                "Two clerks wait by the trough with the ash pan between them, talking about weather in the flat way of men on shift.",
            ...
            { ...pg("The Paperwork", "Beside the fire trough", "Elder Mori",
                ...
                choices: [
                    { text: "Stay for the raking of the ash.", conclusion: "", trait: "", lane: "neutral" as const, nextPage: 2 },
                    { text: "Follow the mourners to the gate.", conclusion: "", trait: "", lane: "neutral" as const, nextPage: 3 }
                ] },
            { ...pg("The Raking", "The trough, yard emptying", "Narrator",
                "The clerks rake the trough in long, practiced pulls. One of them hums until the other looks at him.",
                "The older clerk lifts the pan alone. He has the grip of a man braced for two men's weight, and then he doesn't need it.",
                "He weighs the pan in his hands, twice. He writes nothing down.",
                "On the trough rim, someone has scratched a tally. Old strokes and new. The newest stroke is tonight's."),
                choices: [
                    { text: "Find Toma", conclusion: "", trait: "", lane: "neutral" as const, nextPage: 4 }
                ] },
            { ...pg("The Gate", "Yard gate, mourners filing out", "Narrator",
                "The mother is crying at the gate, and then she is not. Between one breath and the next. Not slowing. Stopping.",
                "An aunt steadies her, then stops needing to.",
                "Behind you, one mourner to another, low. She says she cannot remember what the debt was for. The other says nobody can, that's the point.",
                "They file past the clerk's table and sign out of the yard, neat as a shift change."),
                choices: [
                    { text: "Find Toma", conclusion: "", trait: "", lane: "neutral" as const, nextPage: 4 }
                ] },
            pg("The Count", "The emptying yard, ash settling", "Toma Reed",
                ...
                "One. The heat bent toward the trough, not up. Fires go up.",
                "Two. The mother stopped crying between one breath and the next. Not slowed. Stopped.",
        ...
        interlude("Ashen Leaf Village", 58, "Mori's Cut", [
            pg("The Second Register", "Archive annex, a shelf with no label", "Narrator",
                ...
                "The saucer goes to your side. He keeps the dripping cup, with a folded cloth under it that has done this before.",
            ...
            { ...pg("The Working Copy", "The annex table, two cups", "Elder Mori",
                ...
                choices: [
                    { text: "Ask which entries are in his hand.", conclusion: "", trait: "", lane: "neutral" as const, nextPage: 2 },
                    { text: "Ask who else has read this book.", conclusion: "", trait: "", lane: "neutral" as const, nextPage: 3 }
                ] },
            { ...pg("His Hand", "The annex, lamp trimmed", "Elder Mori",
                "Three. You will note I did not pretend to count.",
                "A dye family, the flood year. A carter who beat his sons. A woman whose name I will not say, because saying it is the one refusal I have left.",
                "The carter was spite dressed as need. I knew it when I signed. The book is honest about that too. See the margin. My hand, smaller than usual.",
                "Drink your tea. It does not improve, but it cools."),
                choices: [
                    { text: "Hear the offer", conclusion: "", trait: "", lane: "neutral" as const, nextPage: 4 }
                ] },
            { ...pg("The Readers", "The annex, lamp trimmed", "Elder Mori",
                "Every keeper of this annex, back nine hands of years. Two Kages. One clerk who read it uninvited.",
                "The clerk is not erased. I want that understood. He copies intake slats in the register hall to this day and has never once looked at me.",
                "Each Kage countersigns the withdrawals. The seat requires it. Whatever you think of Hoshina Enju, she has never let the pen travel without her name behind it.",
                "You may find that damning or dutiful. The book declines to vote."),
                choices: [
                    { text: "Hear the offer", conclusion: "", trait: "", lane: "neutral" as const, nextPage: 4 }
                ] },
        ...
        interlude("Ashen Leaf Village", 70, "The Register Opens", [
            ...
            { ...pg("Three Doors", "The annex, cabinet already open", "Elder Mori",
                ...
                choices: [
                    { text: "Ask what upkeep a name eats.", conclusion: "", trait: "", lane: "neutral" as const, nextPage: 2 },
                    { text: "Ask what the registry pays, exactly.", conclusion: "", trait: "", lane: "neutral" as const, nextPage: 3 }
                ] },
            { ...pg("Upkeep", "The annex", "Elder Mori",
                "Being spoken of. Being owed things. A grave visited, a debt disputed, a grudge kept warm. Any of it will do.",
                "The registry does not track love. It tracks activity. A name with activity is contested, and contested names are worthless to the fire.",
                "Someone tied to that name stopped, recently, all at once. Died, left, or chose to forget. The queue only records the silence.",
                "I looked into which. The trail ends at a burned ferry ledger, which is either an accident or a very good clerk."),
                choices: [
                    { text: "Go and see the slat", conclusion: "", trait: "", lane: "neutral" as const, nextPage: 4 }
                ] },
            { ...pg("The Price", "The annex", "Elder Mori",
                "In coin, more than a jonin's season. The registry does not haggle. Haggling implies the seller might be right to ask.",
                "What they buy is the lack of argument. An uncontested name burns clean, and clean burns pay whoever draws on the account. You have heard me on the arithmetic.",
                "The unsworn woman has been asking the same question, incidentally. Harrow. She asked it in four offices and paid a filing fee in each.",
                "Whatever she is pricing, I would want to be elsewhere when she finishes."),
                choices: [
                    { text: "Go and see the slat", conclusion: "", trait: "", lane: "neutral" as const, nextPage: 4 }
                ] },
            pg("The Slat", "The register wall, fourth slat", "Narrator",
                ...
                "Toma runs a thumb along one rounded corner and puts his hand in his pocket, as if the wood had said something.",
                "He stands where he can see you and pretends to count slats.",
        ...
        interlude("Ashen Leaf Village", 80, "Harrow's Shortcut", [
            pg("Weighing Ash", "The burning yard, empty, past midnight", "Narrator",
                ...
                "There is a tally scratched into the rim by her knee. Old strokes. She has added her own in wax pencil, next to them.",
            ...
            { ...pg("The Rate", "The fire trough rim", "Kite Harrow",
                ...
                choices: [
                    { text: "Ask how she got her own file.", conclusion: "", trait: "", lane: "neutral" as const, nextPage: 2 },
                    { text: "Rest your hand on the trough rim.", conclusion: "", trait: "", lane: "neutral" as const, nextPage: 3 }
                ] },
            { ...pg("The File", "The trough rim, receipts between you", "Kite Harrow",
                "Central retires your born name when they license you. Retires. Their word. It goes in a vault, and the vault has a clerk, and clerks have prices.",
                "Mine cost three jobs, done clean, no invoice. The clerk thinks I wanted it for sentiment. I let him think that. Sentiment is a discount.",
                "I've paid dues in four villages and none of them would bury me inside their walls. So the name is the whole estate.",
                "It's a good name. You'd laugh. Everyone does."),
                choices: [
                    { text: "Hear her terms", conclusion: "", trait: "", lane: "neutral" as const, nextPage: 4 }
                ] },
            { ...pg("What the Trough Keeps", "The trough, the ash not quite cold", "First Flame Avatar",
                "The Flame keeps the given. It keeps the woman on the rim already, a little. She has leaned over the account too long.",
                "It has no word for wanted. Given, taken, kept. Nothing else was ever taught to it.",
                "What she means to feed it will be kept whole. Kept is not spent. Tell her, if telling is a thing you still do.",
                "Six days since a burning, and the stone under your hand is warm. The Flame keeps that too."),
                choices: [
                    { text: "Hear her terms", conclusion: "", trait: "", lane: "neutral" as const, nextPage: 4 }
                ] },
            pg("The Deposit", "The trough, receipts between you", "Kite Harrow",
                ...
                "Except one. My born name, retired, filed, and bought back. You know the story or you don't. It doesn't change the figures.",
        ...
        interlude("Ashen Leaf Village", 92, "Witnesses", [
            { ...pg("The One Who Counted", "The grove road, first light", "Toma Reed",
                ...
                choices: [
                    { text: "Ask what the list's best reason was.", conclusion: "", trait: "", lane: "neutral" as const, nextPage: 1 },
                    { text: "Tell him to keep counting, whatever happens.", conclusion: "", trait: "", lane: "neutral" as const, nextPage: 2 }
                ] },
            { ...pg("The Best Reason", "The grove road", "Toma Reed",
                "That you'd win. That was the best one. That you'd walk in, and the hall would offer you the ledger, and the ledger is very good at being carried.",
                "I watched Mori carry it. He's not a bad man. That's the whole problem with the arithmetic. It doesn't need bad men. It prefers the other kind.",
                "The list lost anyway. You count things nobody pays you to count. Offices don't teach that. They tax it.",
                "It's a long walk. I'll shut up at the second bend."),
                choices: [
                    { text: "Walk on", conclusion: "", trait: "", lane: "neutral" as const, nextPage: 3 }
                ] },
            { ...pg("The Count Goes On", "The grove road", "Toma Reed",
                "I already bought the book. Fresh one. Pocket size, bad paper, the kind nobody steals.",
                "If it goes wrong in there, the count is what's left. Bent heat, light pans, names that go through quiet. Somebody has to keep the page.",
                "I'll teach it to someone worse at apologizing than me. That's the succession plan. It took all night and I'm proud of it.",
                "Second bend coming up. Mori's there. Pretend to be surprised."),
                choices: [
                    { text: "Walk on", conclusion: "", trait: "", lane: "neutral" as const, nextPage: 3 }
                ] },
