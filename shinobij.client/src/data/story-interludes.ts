    ...
    "Stormveil Village": [
        ...
        interlude("Stormveil Village", 88, "The Quiet Storm", [
            ...
            { ...pg("You Hold the Sky", "The mast foot, Mira wrapping the slate in oilcloth with rigger's care", "Mira Volt",
                ...
                "There was supposed to be a speech. Years of drafts, revised quarterly like a good exit plan. None of it survived to tonight. What's left is: she was right, and I'm her daughter, and you're going to hear both.",
        ...
        interlude("Stormveil Village", 92, "Witnesses", [
            ...
            pg("The Village on the Hill", "The tower gate, the crowd on every switchback below, wind steady", "Mira Volt",
                "Count the switchbacks. Every one of them is full. The camp came down from the ravine, the Terraces came up with rigging pins in their belts, Pike's whole yard walked out mid-training. The Captain's guards are up here off duty, in their good coats, standing next to people they booked last spring.",
    ...
    "Ashen Leaf Village": [
        interlude("Ashen Leaf Village", 20, "The Unsworn", [
            ...
            pg("The Refund", "The annex steps", "Kite Harrow",
                ...
                "I refunded that part of the fee. The road will route me back here eventually. It always does."),
        ], [
        ...
        interlude("Ashen Leaf Village", 92, "Witnesses", [
            ...
            pg("The Village Behind You", "The tower road, doors opening along the row", "Toma Reed",
                "Listen to the doors. They're opening all the way down the row.",
                "Sera told her sewing circle. The circle told the row. Jorun is at his gate holding a drawing of a bridge he can't explain keeping, and he's coming anyway. Imera's locked her house and she's already ahead of us. Somebody's wrapped bread for the road; I can smell it from here.",
    ...
    "Frostfang Village": [
        ...
        interlude("Frostfang Village", 58, "Sova's Cut", [
            ...
            pg("The Keeper's Exemption", "The records room, the meter humming, the pen waiting", "Elder Sova",
                ...
                "One condition, unbendable. Captain Yura's ridge post stays out of every reckoning you ever make. That strike is the one page I falsified gladly, to keep a nineteen-day miracle from being read into a policy problem. Yura earned the right to remember those nineteen days as hers. I will not turn her dead into another lesson for the Count. Not while I hold a pen.",
        ...
        interlude("Frostfang Village", 88, "The Long Lanterns", [
            ...
            { ...pg("You Hold the Stair", "The lantern crate, Yura folding the letter into her breast pocket, drill fashion", "Captain Yura",
                "Good. Then I answer his Roll, and you hold the stair. That's the posting. I outrank you tonight, and the stair is the heavier post anyway.",
                ...
                "I wrote three points on the walk up, drill-perfect, with a close. None of them survive contact. What survives is: he came back for me, and nobody made him, and that's the whole doctrine of everything.",
            ...
            { ...pg("Kept, Not Carried", "The lantern crate, the letter going back into your kit, Yura watching", "Captain Yura",
                ...
                "Log this: not angry. It won't repeat this season. You pulled his kit off a windbreak in a quarry when no one was looking for it, and I will owe you that until the last roll call. The FULL weight of it, no shortcut.",
        ...
        interlude("Frostfang Village", 92, "Witnesses", [
            ...
            pg("The Rows Answer", "The vault forecourt, the White Silence in its rows, lanterns gathering behind", "Captain Yura",
                "Listen. HALDE. There. A voice answers from the lower road. VESSIK. Another, from the snowfield. TARN. From the wall itself.",
                "I called ten names on the way down here, and by the tenth the whole slope was answering. Nobody ordered them. No mark compelled them. I called their names and they chose to answer. That's the Roll, Kage's law or no Kage's law. The wall watch came off the wall. Essen's whole gate crew, off duty, lanterns up. The Pack is on the ridge line waiting for a bell.",
    ...
    "Moonshadow Village": [
        ...
        interlude("Moonshadow Village", 30, "One True Thing", [
            pg("The Verified Truth", "Nyx's stall over the dye canal, one lamp, one slip of paper face-down", "Nyx",
                ...
                "Verification slips are under the paper. Handwriting analysis included, and here's the detail you're paying cost for: the handwriting goes SLOPPY where they wrote about you being kind. Guilt does that to a pen. They hate the job. They do the job. Both things are true. That's Moonshadow for you.",
        ...
        interlude("Moonshadow Village", 88, "The Returning", [
            ...
            { ...pg("Held, Not Returned", "The booth, the file going back into your coat, Nyx watching it go", "Nyx",
                ...
                "Anger's not entered in the ledger. Check it yourself. You pulled that folder out of the machine when it would've been profitable fifty ways to leave it, and I will owe you that at any exchange rate, forever. True thing, no receipt.",
        ...
        interlude("Moonshadow Village", 92, "Witnesses", [
            ...
            pg("The Windows Light", "The canal at full dark, returned files appearing in windows, masks left on sills", "Nyx",
                "Look at the windows. An hour ago one returned file appeared in a window on the east canal, set open, with a lamp behind it. Then another. Then a mask came off across the water and got left on the sill, next to the name it used to hide.",
                "The dye-hand's whole street is lit; he's telling his bad winter to ANYONE who slows down, it's insufferable, I love it. The booth clerks set their meters in their windows, face down. The watch officer hung his hood on a nail where the whole street can see it.",
                "Nobody's marching. Nobody needs to. By the time you reach the tower bridge tomorrow, the whole market will be lit from inside, and she can see every window from up there. I checked, professionally, out of disbelief: nobody is being paid for any of this. The Mirror has no column for it. I barely do.",
                "So decide how you climb tomorrow, friend, because every lit window on this canal climbs with you, and for the first time in this village's ledger, the whole thing is UNPRICED."),
        ], [
