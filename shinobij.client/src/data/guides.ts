        ...
        },
        {
            ...
            blocks: [
                ...
                { type: "list", items: [
                    ...
                    "Targeting & method — Single (normal), AOE Circle (blink to a tile and hit everything around your landing spot; auto-adds the Move tag; +1 pt), or Instant Effect (drop a 2-round zone on open ground; +1 pt).",
                ] },
            ],
        },
        {
            ...
            blocks: [
                { type: "table", head: ["Design choice", "Point cost"], rows: [
                    ...
                    ["AOE Circle or Instant Effect method", "+1 pt"],
        ...
        },
        {
            ...
            blocks: [
                ...
                { type: "table", head: ["Tag", "Cost", "What it does"], rows: [
                    ...
                    ["Move", "0.5", "Reposition on the grid (required by the AOE Circle method)."],
