...
import {
    ...
    GiBlackBelt, GiShield, GiNotebook, GiBrickWall, GiMegaphone, GiCastle, GiLaurelsTrophy, GiDragonHead,
} from "react-icons/gi";
...
import { ClanRaid } from "./ClanRaid";
import { clanRaidEnabled } from "../lib/clan-raid-api";
...
export function ClanHall({ character, updateCharacter, creatorItems, setScreen }: { character: Character; updateCharacter: React.Dispatch<React.SetStateAction<Character | null>>; creatorItems: GameItem[]; setScreen: (s: Screen) => void }) {
    ...
    const [view, setView] = useState<"roster" | "guard" | "treasury" | "boosts" | "upgrades" | "missions" | "wars" | "rankings" | "raid" | "territory" | "notices" | "hall" | "mentor">("roster");
    const raidTabEnabled = clanRaidEnabled();
    ...
    return <div className="card clan-hall-screen">
        ...
        <div className="clan-tabs expanded-tabs"><button className={view === "roster" ? "active" : ""} onClick={() => setView("roster")}><GiThreeFriends style={CH_ICON} />Roster</button><button className={view === "treasury" ? "active" : ""} onClick={() => setView("treasury")}>Treasury</button><button className={view === "boosts" ? "active" : ""} onClick={() => setView("boosts")}><GiUpgrade style={CH_ICON} />Boosts</button><button className={view === "upgrades" ? "active" : ""} onClick={() => setView("upgrades")}><GiBrickWall style={CH_ICON} />Upgrades</button><button className={view === "missions" ? "active" : ""} onClick={() => setView("missions")}><GiScrollUnfurled style={CH_ICON} />Missions</button><button className={view === "wars" ? "active" : ""} onClick={() => setView("wars")}><GiCrossedSwords style={CH_ICON} />Wars</button><button className={view === "rankings" ? "active" : ""} onClick={() => setView("rankings")}><GiLaurelsTrophy style={CH_ICON} />Rankings</button>{raidTabEnabled && <button className={view === "raid" ? "active" : ""} onClick={() => setView("raid")}><GiDragonHead style={CH_ICON} />Raid</button>}<button className={view === "territory" ? "active" : ""} onClick={() => setView("territory")}><GiTreasureMap style={CH_ICON} />Territory</button><button className={view === "guard" ? "active" : ""} onClick={() => setView("guard")}>Guard</button><button className={view === "notices" ? "active" : ""} onClick={() => setView("notices")}><GiNotebook style={CH_ICON} />Notices</button><button className={view === "hall" ? "active" : ""} onClick={() => setView("hall")}><GiCastle style={CH_ICON} />Hall</button><button className={view === "mentor" ? "active" : ""} onClick={() => setView("mentor")}><GiBlackBelt style={CH_ICON} />Mentor</button></div>
        ...
        {view === "raid" && raidTabEnabled && <ClanRaid character={character} updateCharacter={updateCharacter} />}
