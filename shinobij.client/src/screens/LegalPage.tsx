        ...
        sections: [
            {
                ...
                content: <>
                    <p>This is the fastest route and needs no one's help. Sign in, open <strong>Settings</strong> beside Logout in the menu, and choose <strong>Request account deletion</strong>. After the 24-hour wait, return to Settings and choose <strong>Delete account permanently</strong>. Accounts with a password must re-enter it.</p>
                    <p>You can cancel the request during or after the wait. Nothing is deleted automatically. Once you confirm permanent deletion after the wait, there is no undo.</p>
                </>,
            },
            {
                id: "cannot-sign-in",
