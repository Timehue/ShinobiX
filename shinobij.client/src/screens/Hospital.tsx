                ...
                <section className="facility-panel hospital-admission-panel">
                        ...
                        {!isHealer && (
                            <article className="hospital-release-option">
                                ...
                                <div>
                                    ...
                                    <strong>{freeCheckoutReady ? "Ready now" : `${remaining}s remaining`}</strong>
                                ...
                                {freeCheckoutReady ? (
                                    ...
                                    <div className="hospital-countdown" aria-label={`${remaining} seconds until free checkout`}>
                                        <span style={{ width: `${Math.max(0, Math.min(100, (1 - remaining / 60) * 100))}%` }} />
                                    </div>
                                )}
                            </article>
                        )}
                    ...
                    {character.ryo < dischargeCost && !freeCheckoutReady && (
                        <p className="facility-inline-warning">
                            Your wallet is short {(dischargeCost - character.ryo).toLocaleString()} ryo. Free checkout unlocks in {remaining}s.
                        </p>
                    )}
                </section>
            </div>
