...
const LOCATIONS: VillageLocation[] = [
    { name: "Battle Arena", img: battleArenaIcon, screen: "battleArena", x: "10%", y: "31%" },
    { name: "Story Hall", img: storyHallIcon, screen: "storyHall", x: "29%", y: "33%" },
    { name: "Town Hall", img: townHallIcon, screen: "townHall", x: "50%", y: "22%" },
    { name: "Bank", img: bankIcon, screen: "bank", x: "68%", y: "31%" },
    { name: "Shop", img: shopIcon, screen: "shop", x: "18%", y: "79%" },
    { name: "Clan Hall", img: clanHallIcon, screen: "clan", x: "13%", y: "57%" },
    { name: "Hospital", img: hospitalIcon, screen: "hospital", x: "66%", y: "56%" },
    { name: "Mission Hall", img: missionHallIcon, screen: "missions", x: "68%", y: "75%" },
    { name: "Cafeteria", img: cafeteriaIcon, screen: "cafeteria", x: "82%", y: "45%" },
    { name: "Tavern", img: tavernIcon, screen: "tavern", x: "82%", y: "63%" },
    { name: "Stat Training", img: statTrainingIcon, screen: "training", x: "83%", y: "25%" },
    { name: "Jutsu Training", img: jutsuTrainingIcon, screen: "jutsuTraining", x: "80%", y: "81%" },
    { name: "World Map", img: worldMapIcon, screen: "worldMap", x: "45%", y: "68%" },
    { name: "Pet Yard", img: petYardIcon, screen: "pets", x: "32%", y: "55%" },
    { name: "Card Hall", img: cardHallIcon, screen: "shinobiTiles", x: "52%", y: "55%" },
];
