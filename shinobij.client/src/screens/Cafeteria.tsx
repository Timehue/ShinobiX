...
export function Cafeteria({ character, updateCharacter, onBack }: { character: Character; updateCharacter: (character: Character) => void; onBack: () => void }) {
