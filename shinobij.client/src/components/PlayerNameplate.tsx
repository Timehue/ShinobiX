...
import { RARITY_COLORS, titleStyleColor, type LegacyRarity } from "../lib/legacy";
...
export function PlayerNameplate({ name, level, customTitle, customTitleStyle, customTitleIcon, legacyTitle, legacyRarity, village }: {
    name: string;
    level?: number;
