    ...
    return (
        <div className="summary-box">
            ...
            <p className="hint" style={{ marginTop: 14, fontSize: "0.78rem" }}>
                Tip: Clan wars deal HP damage by challenge type — Combat ({CW_DAMAGE.pvp1v1} / {CW_DAMAGE.pvp2v2}) &gt; Pet ({CW_DAMAGE.pet1v1} / {CW_DAMAGE.pet2v2}) &gt; Chronicle Duel ({CW_DAMAGE.tilecards}). Drive the enemy clan to 0 HP to win.
            </p>
