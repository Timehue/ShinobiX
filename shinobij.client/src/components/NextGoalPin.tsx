 ...
 * screen — visible from level 1 on the Village / Central hubs.
 *
...
export function NextGoalPin({ character, navigate }: { character: Character; navigate: (s: Screen) => void }) {
    ...
    return (
        ...
        >
            <div style={{ flex: 1, minWidth: 200 }}>
                <div style={{ fontSize: 11.5, fontWeight: 700, letterSpacing: 0.3, color: "#facc15", textTransform: "uppercase" }}>
