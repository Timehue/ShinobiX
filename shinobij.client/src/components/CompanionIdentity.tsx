...
export function CompanionIdentity({ pet, sharedImages, compact = false }: {
    pet: Pet;
    ...
    return <span className={`companion-identity${compact ? " companion-identity--compact" : ""}`}>
        <span className="companion-identity-art"><PetArtwork pet={pet} sharedImages={sharedImages} fallbackClassName="companion-identity-fallback" /></span>
