...
const migrate_to_base_js_1 = __importDefault(require("./api/admin/migrate-to-base.js"));
...
const spire_leaderboard_js_1 = __importDefault(require("./api/towers/spire-leaderboard.js"));
...
const get_js_3 = __importDefault(require("./api/clan-boss/get.js"));
const assault_start_js_1 = __importDefault(require("./api/clan-boss/assault-start.js"));
const assault_settle_js_1 = __importDefault(require("./api/clan-boss/assault-settle.js"));
...
const eras_js_1 = __importDefault(require("./api/eras.js"));
...
function gracefulShutdown(code, reason) {
    ...
    void (0, socket_js_1.closeSocketServer)().catch(() => undefined);
    void (0, _storage_js_1.closeStoragePool)().catch(() => undefined);
    let exited = false;
    const exit = (how) => {
        if (exited)
            return;
...
route('/admin/migrate-to-base', migrate_to_base_js_1.default);
...
route('/towers/spire-leaderboard', spire_leaderboard_js_1.default);
...
route('/clan-boss/get', get_js_3.default);
route('/clan-boss/assault-start', assault_start_js_1.default);
route('/clan-boss/assault-settle', assault_settle_js_1.default);
...
app.get(/(.*)/, (_req, res) => {
    ...
    try {
        // eslint-disable-next-line @typescript-eslint/no-require-imports
        const fs = require('node:fs');
        _indexHtmlCache = fs.readFileSync((0, node_path_1.join)(staticDir, 'index.html'));
        res.type('html').send(_indexHtmlCache);
    }
    catch {
