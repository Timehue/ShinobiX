...
(0, node_test_1.test)('payouts stay within their advertised ranges', () => {
    ...
    strict_1.default.ok(scraps.ryo >= 8_000 && scraps.ryo <= 24_000);
    const scrapsMax = (0, _black_market_js_1.rollBlackMarket)(seeded(0.0, 0.999));
    strict_1.default.ok(scrapsMax.ryo >= 8_000 && scrapsMax.ryo <= 24_000);
    const haul = (0, _black_market_js_1.rollBlackMarket)(seeded(0.8, 0.999));
    strict_1.default.ok(haul.ryo >= 44_000 && haul.ryo <= 76_000);
    ...
    strict_1.default.equal(jackpot.ryo, 100_000);
