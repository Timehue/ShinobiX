...
exports.pvpSettlementId = pvpSettlementId;
exports.inspectPvpCredit = inspectPvpCredit;
exports.embedPvpSettlementReceipt = embedPvpSettlementReceipt;
 ...
 */
function pvpSettlementId(kind, battleId) {
 ...
 */
function inspectPvpCredit(character, settlementId, fingerprint) {
    const r = (0, _settlement_receipts_js_1.inspectSettlementReceipt)(character, settlementId, fingerprint);
 ...
 */
function embedPvpSettlementReceipt(creditedCharacter, receipts, settlementId, fingerprint, now) {
    return (0, _settlement_receipts_js_1.appendSettlementReceipt)(creditedCharacter, receipts, {
