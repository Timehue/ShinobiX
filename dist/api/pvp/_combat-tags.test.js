...
(0, node_test_1.describe)('fixed-effect control jutsu deal STANDARD damage, not the EP-100 sentinel', () => {
    (0, node_test_1.it)('a sanitized 60-AP Stun jutsu (legacy EP 100) deals standard ~1280, not ~3200, and still stuns', () => {
        ...
        node_assert_1.strict.equal(dealt, 1280, 'standard 60-AP damage (EP 40 × 32), NOT 3200 (EP 100 × 32)');
