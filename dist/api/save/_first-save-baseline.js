...
exports.FIRST_SAVE_INVENTORY = exports.FIRST_SAVE_RYO = void 0;
exports.applyCanonicalFirstSave = applyCanonicalFirstSave;
...
exports.FIRST_SAVE_RYO = 100;
exports.FIRST_SAVE_INVENTORY = ['rustfang-kunai', 'shinobi-vest'];
...
function applyCanonicalFirstSave(character) {
    const next = { ...character };
    const stats = Object.fromEntries(_xp_engine_js_1.STAT_KEYS.map((key) => [key, 10]));
    const maxHp = (0, _xp_engine_js_1.maxHpForLevel)(1);
    const maxChakra = _xp_engine_js_1.COMBAT_RESOURCES_V2 ? _xp_engine_js_1.CHAKRA_BASE_V2 : (0, _xp_engine_js_1.maxChakraForLevel)(1);
    const maxStamina = _xp_engine_js_1.COMBAT_RESOURCES_V2 ? _xp_engine_js_1.STAMINA_BASE_V2 : (0, _xp_engine_js_1.maxStaminaForLevel)(1);
    next.level = 1;
    next.xp = 0;
    next.ryo = exports.FIRST_SAVE_RYO;
    next.stats = stats;
    next.unspentStats = _xp_engine_js_1.STARTING_STAT_POINTS;
    next.hp = maxHp;
    next.maxHp = maxHp;
    ...
    next.inventory = [...exports.FIRST_SAVE_INVENTORY];
    next.itemStacks = [];
    next.pets = [];
    next.tileCards = [];
    next.equipment = {};
    ...
    for (const key of ZERO_CURRENCIES)
        next[key] = 0;
    for (const key of ZERO_PROGRESS_COUNTERS)
        next[key] = 0;
