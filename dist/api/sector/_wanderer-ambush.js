...
exports.AMBUSH_REWARDS_PER_DAY = exports.AMBUSH_KILLS_REQUIRED = void 0;
exports.rollAmbushReward = rollAmbushReward;
exports.ambushCleared = ambushCleared;
exports.AMBUSH_KILLS_REQUIRED = 4; // 3 robbers + 1 boss
exports.AMBUSH_REWARDS_PER_DAY = 3; // cap on paid ambush clears / UTC day
...
function rollAmbushReward(level, rng) {
...
function ambushCleared(baseline, current) {
    return (Number(current) || 0) - (Number(baseline) || 0) >= exports.AMBUSH_KILLS_REQUIRED;
}
