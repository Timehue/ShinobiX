...
(0, node_test_1.describe)('bankInterestPercent (verbatim villageUpgradeBonus bank)', () => {
    (0, node_test_1.it)('0.25% per bank level, clamped to 50', () => {
        ...
        node_assert_1.strict.equal((0, _bank_interest_js_1.bankInterestPercent)({ villageUpgrades: { bank: 1 } }), 0.25);
        node_assert_1.strict.equal((0, _bank_interest_js_1.bankInterestPercent)({ villageUpgrades: { bank: 20 } }), 5);
        node_assert_1.strict.equal((0, _bank_interest_js_1.bankInterestPercent)({ villageUpgrades: { bank: 50 } }), 12.5);
        node_assert_1.strict.equal((0, _bank_interest_js_1.bankInterestPercent)({ villageUpgrades: { bank: 999 } }), 12.5); // clamp
