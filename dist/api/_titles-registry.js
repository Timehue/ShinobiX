...
exports.CUSTOM_TITLE_LOG_KEY = exports.TITLE_ICON_SET = exports.TITLE_STYLE_IDS = exports.ERA_TRIGGER_TITLES = exports.LEGACY_ONLY_TITLES = exports.KNOWN_EARNED_TITLES = exports.KAGE_LIBERATOR_TITLES = exports.ACHIEVEMENT_TITLES = void 0;
...
exports.KNOWN_EARNED_TITLES = new Set([
    ...
    ...Object.values(exports.KAGE_LIBERATOR_TITLES),
].map((t) => t.toLowerCase()));
/**
...
const LIBERATOR_TITLE_SET = new Set(Object.values(exports.KAGE_LIBERATOR_TITLES).map((t) => t.toLowerCase()));
...
function isServerCreditedTitle(text) {
    ...
    return exports.LEGACY_ONLY_TITLES.has(key) || exports.ERA_TRIGGER_TITLES.has(key) || LIBERATOR_TITLE_SET.has(key);
}
