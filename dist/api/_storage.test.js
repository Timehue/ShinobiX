...
(0, node_test_1.describe)('SQL key-pattern escaping', () => {
    (0, node_test_1.it)('escapes LIKE metacharacters and escape characters before expanding glob syntax', () => {
...
(0, node_test_1.describe)('_makeRemoteKv transport resilience', () => {
    ...
    const kv = () => (0, _storage_js_1._makeRemoteKv)('https://proxy.example/api/kv', 'tok', { allowedHosts: new Set(['proxy.example']) });
    (0, node_test_1.it)('rejects unapproved, insecure, and ambiguous proxy destinations before fetch', () => {
        for (const url of [
            ...
            node_assert_1.strict.throws(() => (0, _storage_js_1._makeRemoteKv)(url, 'tok'));
        }
        node_assert_1.strict.doesNotThrow(() => (0, _storage_js_1._makeRemoteKv)('https://theravensark.com/api/kv/', 'tok'));
    });
