...
def main() -> None:
    ...
    shots = [
        ...
        Shot("world-map-open", assets / "Maps" / "world_map.webp", 4.737, 7.175, motion="whip_lr", particles="ash"),
        ...
        Shot("clan-war-a", public / "landing-clanwar.webp", 20.039, 21.618, motion="whip_rl", particles="ash", grade="storm"),
        ...
        Shot("map-return", assets / "Maps" / "world_map.webp", 36.014, 37.593, motion="whip_rl", particles="ash"),
        Shot("fight-for-clan", public / "landing-clanwar.webp", 37.593, 39.195, motion="fast_push", caption="FIGHT FOR YOUR CLAN", particles="ash", flash=True),
        ...
        Shot("rapid-map", assets / "Maps" / "world_map.webp", 72.815, 73.604, motion="whip_rl", particles="ash"),
        Shot("rapid-clan", public / "landing-clanwar.webp", 73.604, 74.393, motion="fast_push", particles="ash", flash=True),
