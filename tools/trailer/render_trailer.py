...
def main() -> None:
    ...
    shots = [
        ...
        Shot("four-villages-map", assets / "Maps" / "world_map.webp", 14.303, 21.571, "pull"),
        Shot("rival-banners", public / "landing-clanwar.webp", 21.571, 27.121, "push", "FOUR RIVAL VILLAGES"),
        ...
        Shot("world-paths", assets / "Maps" / "world_map.webp", 65.016, 72.191, "pan_lr"),
        Shot("lone-shinobi", public / "landing-hero-keyart.webp", 72.191, 78.112, "drift_left"),
        Shot("war-musters", public / "landing-clanwar.webp", 78.112, 83.476, "fast_push"),
