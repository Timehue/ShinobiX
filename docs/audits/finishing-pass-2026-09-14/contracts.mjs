...
const additional = [
    ...
    ['pet-training-and-care', 'Pet training, care and evolution', ['api/pet/progress.ts', 'api/pet/_progress.ts', 'api/pet/evolve.ts'], 'Pet XP and growth are distinct from shinobi stats; sealed timers protect completion. C2 fixed with owner-approved additive Den/Yard bonus on new sessions; old sealed sessions retain their reward.'],
    ...
    ['clan-progression', 'Clan missions, upgrades, mentorship and Exchange', ['api/clan/mission/claim.ts', 'api/clan/mission/_settlement.ts', 'api/clan/upgrade/purchase.ts', 'api/clan/mentor.ts', 'api/clan/exchange/purchase.ts', 'api/clan/exchange/_settlement.ts'], 'Clan XP, treasury, War Supply and Clan Points are distinct stores. C3/C4 fixed for new protocols with server-bound co-written proofs and local interruption tests; historical ambiguity remains unresolved.'],
