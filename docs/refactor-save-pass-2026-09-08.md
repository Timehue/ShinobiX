...
- Whole-suite run: 9,686 of 9,692 passed; all six failures were source-location checks for the moved story-progress, attunement, Nindo and name-length constraints. After updating those reads, all 62 affected contract cases pass. A final complete run remains required after the remaining roadmap work.
