...
> Generated from [api/_legacy-defs.ts](../api/_legacy-defs.ts) — the canonical source. Do not hand-edit this file; regenerate it after roster changes. Thresholds are the launch baseline (level 1–50 achievements) and are runtime-tunable via the shared:legacy-defs admin overlay (an overlay value of 0 waives a requirement). Every requirement stat is verified to have a live write path or capped save-mirror by the dead-stat lint in api/_legacy-defs.test.ts.

## MYTHIC (10)

| Legacy | Title | Category | Village | Requirements (all) | Flavor |
|---|---|---|---|---|---|
| **Legacy of the First Flame** | First Flame Bearer | explorer | — | firstClears ≥ 1; missionCompletions ≥ 600; pveKills ≥ 3,000; warContribution ≥ 200,000; eventCompletions ≥ 10; tilesExplored ≥ 2,000 | Before the roads had names, someone had to walk them burning. The world remembers who lit the way first. |
...
| **Legacy of the World Awakener** | World Awakener | pve | — | weeklyBossTop10 ≥ 8; bossContribution ≥ 1,200,000; eventCompletions ≥ 15; pvpWins ≥ 150; firstClears ≥ 1; warContribution ≥ 100,000 | The great beasts do not stir for armies. They stir for the one name the world keeps repeating. |
...
| **Legacy of the Void Whisper** | Void Whisper | genjutsu | — | genjutsuKills ≥ 400; genjutsuDamage ≥ 350,000; defensiveWins ≥ 40 | It never raised its voice. It lowered the world’s instead. |
| **Legacy of the Arena Demon** | Arena Demon | taijutsu | — | taijutsuKills ≥ 600; pvpWins ≥ 150; sameRankWins ≥ 40 | The crowd stopped betting on outcomes years ago. Now they only bet on how long. |
